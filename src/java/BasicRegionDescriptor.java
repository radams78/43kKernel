...
public class BasicRegionDescriptor extends RegionDescriptor {
    ...
    BasicRegionDescriptor(BoundaryGarden g, int boundaryID, InternalType leftInternalType, InternalType rightInternalType, boolean hasLeftEdge, boolean hasRightEdge) {
	this.myGarden = g;
	...
	ans = ans + " | LI: " + leftInternalType + " | RI: " + rightInternalType;
